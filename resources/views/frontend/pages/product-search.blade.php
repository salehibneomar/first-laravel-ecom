    ...
    <div class="clearfix filters-container m-t-10">
      <div class="row">
        ...
        <div class="col col-md-12">
          <div class="badge" style="display: inline-block !important; margin-bottom: 25px !important; background-color: rgb(44,169,77) !important; padding: 5px;">
            {{ $totalData }}
            {{ Str::pluralStudly('Product', $totalData) }} found!
          </div>
          <form action="{{ url(URL::current()) }}" method="get" id="sort-and-filter">
            <input type="hidden" name="q" value="{{ $key }}" readonly required >
      ...
      <div class="clearfix filters-container">
        <div class="text-right">
          <div class="pagination-container">
            {{ $searchedProducts->links('vendor.pagination.custom') }}
            <!-- /.list-inline --> 
          </div>
