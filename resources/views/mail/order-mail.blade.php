...
<h1 style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 18px; font-weight: bold; margin-top: 0; text-align: left;">Hello, your order has been received!</h1>
...
<tr>
    <td>TrxID: {{ $emailData['trans_id'] }}</td>
</tr>
<tr>
    <td>Name: {{ $emailData['name'] }}</td>
</tr>
<tr>
    <td>Email: {{ $emailData['email'] }}</td>
</tr>
<tr>
    <td>Initial Amount: {{ $emailData['initial_amount'] }}</td>
</tr>
<tr>
    <td>Discount Amount: {{ $emailData['discount_amount'] }}</td>
</tr>
<tr>
    <td>Final Amount: {{ $emailData['amount'] }}</td>
</tr>
<tr>
    <td>Currency: {{ $emailData['currency'] }}</td>
</tr>
<tr>
    <td>Payment Method: {{ $emailData['payment_method'] }}</td>
</tr>
</table>
</td>
</tr>
